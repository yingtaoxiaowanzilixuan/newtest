...
(function () {
    ...
    */
     BMapLib.LuShu = function (map, path, opts) {
         ...
         this._opts = {
             ...
             num:'',//距离当前站还有几站
             name:'',
             InfoWindow:null,//是否显示上方详细信息overlay
             nextStationName:''//下一站
         };
    ...
    */
    ...
    //@mit清除
    LuShu.prototype.remove = function () {
        var me = this;
        me._removeMarker();
        this.i = 0;
        this._fromStop = true;
    ...
    */
    ...
    baidu.object.extend(LuShu.prototype, {
        ...
        * @return 无返回值.
        */
       _removeMarker: function (callback) {
            if (this._marker) {
                this.stop();
                this._map.removeOverlay(this._marker);
                clearTimeout(this._timeoutFlag);
            ...
            //移除之前的overlay
            if(this._overlay && this._opts.InfoWindow!=null)
            {
               this._map.removeOverlay(this._opts.InfoWindow);
               // this._opts.InfoWindow.close();
            }
            this._overlay && this._map.removeOverlay(this._overlay);
...
//                    me._removeMarker();
    ...
    */
    ...
    CustomOverlay.prototype.initialize = function (map) {
        var div = this._div = baidu.dom.create('div', { style: 'z-index:0;border:solid 1px #ccc;width:auto;min-width:50px;text-align:center;position:absolute;background:rgba(255,255,255,0.9);color:#000;font-size:12px;border-radius: 5px;padding:5px;white-space: nowrap;font-family:微软雅黑;font-weight: 700;' });
        div.innerHTML = this._html;
        this._infoWindow=this.lushuMain._opts.InfoWindow;
        var customoverlay=this;
        div.title=customoverlay.lushuMain._opts.time;

        div.addEventListener("click",function(customoverlay){
          return function(){ 
            var opts=customoverlay.lushuMain._opts;
            var content = "<div class='infoBoxlist' ><ul><li><span>距离查询站：</span><strong>" + opts.num + "站</strong></li><li><span>到站时间：</span><strong>" + opts.time + "</strong></li><li><span>下一站:</span><strong>" + opts.nextStationName + "</strong></li><li><span>查询站:</span><strong>" + opts.stop + "站</strong></li></ul><div>";
            var infoWindow = new BMapLib.SearchInfoWindow(map,content, {
                //speed:+"   "+opts.speed.toFixed(2)+"m/s</strong>";
                title:"<strong style='font-size:18px'>"+opts.name+""+opts.busselfid,
            ...
            infoWindow.open(customoverlay.lushuMain._marker.getPosition());
            //设置infoWindow的打开或关闭事件
            infoWindow.addEventListener("close",function(){
             //  customoverlay._div.style.visibility = 'visible';
               customoverlay._infoWindow=null;
               opts.InfoWindow=null;
            })
            infoWindow.addEventListener("open",function(){
               customoverlay._infoWindow=infoWindow;
               opts.InfoWindow=infoWindow;
            })
    ...
    baidu.object.extend(CustomOverlay.prototype, {
        ...
        setPosition: function (poi, markerSize) {
            ...
            if(this._infoWindow!=null){
                ...
                this._infoWindow.setPosition(poi);
               // var opts=this.lushuMain._opts;
               // var content = "<div class='infoBoxlist'><ul><li><span>终点站:</span><strong>" + opts.stop + "</strong></li><li><span>到站时间：</span><strong>" + opts.time + "</strong></li><li><span>距离当前站:</span><strong>" + opts.num + "站<strong></li></ul><div>";
               // this._infoWindow.setContent(content);
               // this._infoWindow.setTitle("<strong style='font-size:18px'>"+opts.name+""+opts.busselfid+"</strong>");
