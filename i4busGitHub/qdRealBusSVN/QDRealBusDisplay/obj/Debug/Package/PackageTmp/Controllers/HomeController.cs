       ...
       // [AcceptVerbs(HttpVerbs.Post)]
        ...
        public JsonResult passengerFlowCount2(string dates,string hours)
        {
            using (qdbusDataClassesDataContext ndcs = new qdbusDataClassesDataContext())
            {
                ...
                var all = ndcs.TripOfEachCardRecord_TimeInterval.Where(c => c.Num > 10 && c.Date.ToString() == dates && c.TimeInterval == hours).ToList();
        ...
        public JsonResult passengerFlowCount(string dates,string hours)
        {
            ...
            using (qdbusDataClassesDataContext ndcs = new qdbusDataClassesDataContext())
            {
                ...
                var d1 = ndcs.TripOfEachCardRecord_TimeInterval.Where(c => c.Date.ToString() == diff && c.TimeInterval == hours&&c.Num>10).ToList();              
